...
if((i < len)){
var k = (ks[i]);
var G__13056 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13057 = (i + (1));
m = G__13056;
i = G__13057;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__13061 = c;
var G__13061__$1 = (((G__13061 == null))?null:G__13061.prototype);
if((G__13061__$1 == null)){
return null;
} else {
return (G__13061__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__13065 = c;
var G__13065__$1 = (((G__13065 == null))?null:G__13065.prototype);
if((G__13065__$1 == null)){
return null;
} else {
return (G__13065__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__13071__delegate = function (args){
var G__13069 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13069) : reagent.impl.component.as_element.call(null,G__13069));
};
...
while (G__13072__i < G__13072__a.length) {G__13072__a[G__13072__i] = arguments[G__13072__i + 0]; ++G__13072__i;}
  args = new cljs.core.IndexedSeq(G__13072__a,0);
} 
return G__13071__delegate.call(this,args);};
...
return G__13071__delegate(args);
});
...
var _STAR_current_component_STAR_13076 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13076;
}});
...
var G__13084 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13084) {
...
return ((function (G__13084){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__13087 = reagent.impl.component.state_atom(c);
var G__13088 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__13087,G__13088) : cljs.core.reset_BANG_.call(null,G__13087,G__13088));
});
;})(G__13084))
...
var or__6451__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__6451__auto__){
...
var c = this;
var G__13090_13092 = (c["cljsRatom"]);
if((G__13090_13092 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13090_13092);
}
...
if(cljs.core.truth_((function (){var and__6439__auto__ = wrap;
if(cljs.core.truth_(and__6439__auto__)){
return f;
} else {
...
var renders_13095 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13096 = cljs.core.first(cljs.core.vals(renders_13095));
if((cljs.core.count(renders_13095) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_13095))){
} else {
...
var render_fun__$1 = (function (){var or__6451__auto__ = render_fun;
if(cljs.core.truth_(or__6451__auto__)){
return or__6451__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__6451__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6451__auto__)){
return or__6451__auto__;
} else {
...
var name__$1 = (function (){var G__13094 = name;
switch (G__13094) {
case "":
...
var elem = (function (){var G__13105 = (function (){var or__6451__auto__ = (function (){var G__13107 = c;
if((G__13107 == null)){
return null;
} else {
return (G__13107["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6451__auto__)){
return or__6451__auto__;
...
return (G__13105["_currentElement"]);
}
})();
var name = (function (){var G__13108 = elem;
var G__13108__$1 = (((G__13108 == null))?null:(G__13108["type"]));
if((G__13108__$1 == null)){
return null;
} else {
return (G__13108__$1["displayName"]);
}
})();
var path = (function (){var G__13109 = elem;
var G__13109__$1 = (((G__13109 == null))?null:(G__13109["_owner"]));
var G__13109__$2 = (((G__13109__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__13109__$1) : reagent.impl.component.component_path.call(null,G__13109__$1)));
if((G__13109__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13109__$2),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" > ")].join('');
}
})();
...
var n = (function (){var or__6451__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6451__auto__)){
return or__6451__auto__;
} else {
var G__13111 = c;
var G__13111__$1 = (((G__13111 == null))?null:G__13111.constructor);
if((G__13111__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13111__$1);
}
}
})();
