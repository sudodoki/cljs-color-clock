...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7062__auto__,writer__7063__auto__,opt__7064__auto__){
return cljs.core._write(writer__7063__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13141 = o;
(G__13141[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13142__delegate = function (args){
...
while (G__13143__i < G__13143__a.length) {G__13143__a[G__13143__i] = arguments[G__13143__i + 0]; ++G__13143__i;}
  args = new cljs.core.IndexedSeq(G__13143__a,0);
} 
return G__13142__delegate.call(this,args);};
G__13142.cljs$lang$maxFixedArity = 0;
G__13142.cljs$lang$applyTo = (function (arglist__13144){
var args = cljs.core.seq(arglist__13144);
return G__13142__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6439__auto__ = !((jsprops == null));
if(and__6439__auto__){
var and__6439__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__6439__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__6439__auto____$1;
}
} else {
...
var G__13150 = jsprops;
(G__13150["defaultValue"] = value);

(G__13150["onChange"] = ((function (G__13150,v,value,on_change){
return (function (p1__13147_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13147_SHARP_);
});})(G__13150,v,value,on_change))
);

(G__13150["ref"] = ((function (G__13150,v,value,on_change){
return (function (p1__13148_SHARP_){
return (this$["cljsInputElement"] = p1__13148_SHARP_);
});})(G__13150,v,value,on_change))
);
...
var vec__13157 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13157,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13157,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13157,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13162 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13162 == null)){
} else {
var key_13163 = temp__4661__auto___13162;
(jsprops["key"] = key_13163);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13165 = (new reagent.impl.template.NativeWrapper());
(G__13165["name"] = c);
...
var G__13167 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13167) : reagent.impl.template.as_element.call(null,G__13167));
} else {
...
var len__7564__auto___13173 = arguments.length;
var i__7565__auto___13174 = (0);
while(true){
if((i__7565__auto___13174 < len__7564__auto___13173)){
args__7571__auto__.push((arguments[i__7565__auto___13174]));

var G__13175 = (i__7565__auto___13174 + (1));
i__7565__auto___13174 = G__13175;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7572__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13171){
var G__13172 = cljs.core.first(seq13171);
var seq13171__$1 = cljs.core.next(seq13171);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13172,seq13171__$1);
});
...
break;
default:
var G__13179 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13179;
continue;
...
var n__7374__auto___13182 = a.length;
var i_13183 = (0);
while(true){
if((i_13183 < n__7374__auto___13182)){
(a[i_13183] = reagent.impl.template.as_element((a[i_13183])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7374__auto___13185 = a.length;
var i_13186 = (0);
while(true){
if((i_13186 < n__7374__auto___13185)){
var val_13187 = (a[i_13186]);
if((cljs.core.vector_QMARK_(val_13187)) && ((reagent.impl.template.key_from_vec(val_13187) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13186] = reagent.impl.template.as_element(val_13187));

var G__13188 = (i_13186 + (1));
i_13186 = G__13188;
continue;
} else {
}
...
var ctx = ({});
var vec__13192 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13192,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13192,(1),null);
...
var G__13196 = (cljs.core.count(argv) - first_child);
switch (G__13196) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13196){
